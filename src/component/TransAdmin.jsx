    ...
    return data.map((data) => {
      ...
      return (
          <tr style={{ fontSize : "1.5rem"}}>
            ...
            {data.success=="Success" ? <td style={{paddingBottom : "15px" , paddingTop : "1.5rem" }}>Completed</td> :  data.success=="Failed" ? <td style={{paddingBottom : "15px" , paddingTop : "1.5rem" }}>Failed</td> :<td style={{paddingBottom : "15px" , paddingTop : "1.5rem" }}>Ongoing</td>}
